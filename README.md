...
A stateless conversational AI that guides hiring managers from vague role descriptions to a grounded shortlist of SHL Individual Test Solutions — through multi-turn dialogue, smart clarification, and catalog-grounded retrieval.
...
⚠️ Cold-start notice: The backend is hosted on Render's free tier and may take up to 90 seconds to wake up after inactivity. The /health endpoint will respond once the service is ready.
